...
int adios_declare(int64_t *gh, const char *transport_method, const char* opts)
{
    	...
    	adios_define_var (*gh, "state_id",  "", adios_byte, "64", "", "");
    	adios_define_var (*gh, "num_atoms", "", adios_integer, "", "", "");
    	adios_define_var (*gh, "num_types", "", adios_integer, "", "", "");
	
	adios_define_var (*gh, "cell_dims", "", adios_double, "3,2", "", "");

	adios_define_var (*gh, "type_id", "", adios_integer, "num_types", "", "");
	adios_define_var (*gh, "masses", "", adios_double, "num_types", "", "");

	adios_define_var (*gh, "atom_id", "", adios_integer, "num_atoms", "", "");
	adios_define_var (*gh, "atom_type", "", adios_integer, "num_atoms", "", "");
	adios_define_var (*gh, "px", "", adios_double, "num_atoms", "", "");
	adios_define_var (*gh, "py", "", adios_double, "num_atoms", "", "");
	adios_define_var (*gh, "pz", "", adios_double, "num_atoms", "", "");
	adios_define_var (*gh, "imx", "", adios_integer, "num_atoms", "", "");
	adios_define_var (*gh, "imy", "", adios_integer, "num_atoms", "", "");
	adios_define_var (*gh, "imz", "", adios_integer, "num_atoms", "", "");
	
	adios_define_var (*gh, "atom_vid", "", adios_integer, "num_atoms", "", "");
	adios_define_var (*gh, "vx", "", adios_double, "num_atoms", "", "");
	adios_define_var (*gh, "vy", "", adios_double, "num_atoms", "", "");
	adios_define_var (*gh, "vz", "", adios_double, "num_atoms", "", "");

	return 0;	
}

int adios_write_state(char *adios_file, char *fmode, MPI_Comm comm, pt_atoms *atoms_array)
{
	int64_t fh;
	...
	groupsize  = 2*sizeof(int);   /* num_atoms, num_types */
...
int main(int argc, char *argv[])
{
	...
	char *ptr;
	long long state_id = (unsigned long long) strtoul(argv[6],&ptr,10);
	printf("State id: %llu %s\n",state_id,argv[6]);
	char long_val[256];
	sprintf(long_val,"%llu",state_id);
	printf("long value: %s\n",long_val);
	exit(0);
	...
	if (!strcmp(argv[6],"1")) {
		...
		adios_write_state(argv[2],(char*)"w",comm,&atoms_array);
		fclose(fpi);	
