...
int main(int argc, char *argv[])
{
    ...
    if(comm_rank == 0) {
	printf("pt_producer_global runtime: %lf\n", app_end_time - app_start_time);
	printf("pt_producer_global rank 0 adios_open_time: %lf\n", global_adios_open_time);
	printf("pt_producer_global rank 0 adios_write_time: %lf\n", global_adios_write_time);
	printf("pt_producer_global rank 0 adios_close_time: %lf\n", global_adios_close_time);
    }
    fflush(stdout);
    MPI_Barrier(comm);
